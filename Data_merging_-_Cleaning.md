...
Lets select only columns needed for further analysis and perform basic
summary statistics based on the member type (casual vs membership
riders)
...
Creating summary tables to access ride lengths and ride counts to access
the riding trends and storing results in individual tables for further
analysis
